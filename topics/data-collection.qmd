...
* Standardisation: [codebooks](../guides/document-and-preserve.qmd/##%20Data%20Documentation) & [protocols](##%20Data%20Collection%20Protocols)
* Structure / organisation of the data
* [Data quality assurance methods](../guides/process-and-analyze.qmd)
* [Documentation](../guides/document-and-preserve.qmd/##%20Data%20Documentation) & [metadata](../guides/document-and-preserve.qmd/##%20Metadata)
* [Storage](data-storage.qmd) & [protection](data-protection.qmd)

Systematic data collection is essential for ensuring the reproducibility of research. When data are collected in a consistent and organised manner, it improves the quality and reliability of the research, making the data easier to share and reproduce by others. High-quality data also contribute to making data FAIR (Findable, Accessible, Interoperable, and Reusable), as well-organised and well-documented data is more likely to be reused effectively. The principles of making data FAIR are discussed in detail under the topic [FAIR Principles](fair-principles.qmd).
