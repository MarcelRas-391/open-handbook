...
Information and how to get an account can be found on :lock:[VU Service Portal](https://services.vu.nl/esc) under IT > Research > HPC Cluster Computing
...
Start eduVPN and choose Institute Access to connect. You will need MFA to authenticate. Students can activate MFA at the servicedesk ( :lock:[kb-item 11809](https://services.vu.nl/kb_view.do?sysparm_article=KB0011809) )
